...
/** Reason code for a verification attempt outcome. */
...
/** Per-operation verification result with auth escalation info. */
export interface VerifyResult {
  readonly operationId: string
  readonly overall: 'pass' | 'fail' | 'skipped'
  readonly authWorks: boolean | null
  readonly publicWorks: boolean | null
  readonly attempts: readonly VerifyAttempt[]
}

/** Complete verification report for a generated package. */
