...
**What changed:**
- Created apple-podcasts-fixture with 10 operations: searchPodcasts, searchEpisodes, getPodcastDetails, getPodcastEpisodes, getEpisodeDetails, getPodcastReviews, getTopPodcasts, getTopEpisodes, getGenreCharts, searchAll
