...
**What changed:**
- Created bloomberg-fixture with 10 operations: getTickerBar, getNewsHeadlines, getQuote, getCompanyProfile, getPriceChart, getPriceMovements, getBoardMembers, getIndexMembers, getLatestNews, searchBloomberg
