...
**What changed:**
- Created pinterest-fixture with 10 operations: searchPins, searchBoards, getPinDetails, getBoardDetails, getBoardPins, getUserProfile, getUserBoards, getRelatedPins, getTypeahead, getPinComments
