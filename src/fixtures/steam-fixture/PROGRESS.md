# Steam Fixture — Progress

## 2026-03-24: Initial discovery — 10 operations

**What changed:**
- Created steam-fixture with 10 operations: getAppDetails, searchGames, getAppReviews, getFeatured, getFeaturedCategories, getPackageDetails, getAppNews, getCurrentPlayers, getGlobalAchievements, getAppNewsV1
...
4. Created fixture manually (public API pattern, same as coingecko-fixture) — no capture compilation needed
