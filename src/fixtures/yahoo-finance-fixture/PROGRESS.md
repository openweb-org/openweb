...
**What changed:**
- Created yahoo-finance-fixture with 9 operations: searchTickers, getChart, getSparkline, getScreener, getRatings, getInsights, getTimeSeries, getCalendarEvents, getQuoteType
