...
describe('shouldApplyCsrf', () => {
  it('applies to all methods by default when no scope defined', () => {
    ...
    expect(shouldApplyCsrf(undefined, 'GET')).toBe(true)
    expect(shouldApplyCsrf(undefined, 'HEAD')).toBe(true)
  })
