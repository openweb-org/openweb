...
**What changed:**
- Created espn with 10 operations: getScoreboard, getGameSummary, getNews, getTeams, getTeamDetail, getStandings, getAthlete, getTeamSchedule, getScoreboardHeader, searchESPN
...
**Verification:** Pending — to be verified via `pnpm dev verify espn`
