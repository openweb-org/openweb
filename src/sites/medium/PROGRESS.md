...
**What changed:**
- Created medium with 10 operations: searchArticles, getTagFeed, getTagCuratedLists, getTagWriters, getRecommendedFeed, getRecommendedTags, getPublicationPosts, getPostClaps, getRecommendedWriters, getUserProfile
