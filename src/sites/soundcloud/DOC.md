...
| getTrack | full track details | trackId ← searchTracks | title, duration, plays, likes, waveform_url, genre | includes user object |
| getUser | artist/user profile | userId ← getTrack.user.id | username, bio, followers, track_count, verified | |
| getPlaylist | playlist with tracks | playlistId | title, track_count, duration, tracks[] | tracks array embedded |
...
# Get track details
openweb soundcloud exec getTrack '{"trackId": 899253886}'

# Get artist profile
openweb soundcloud exec getUser '{"userId": 336200682}'

# Get playlist
openweb soundcloud exec getPlaylist '{"playlistId": 1710939930}'
```
