...
**What changed:**
- Created xueqiu with 10 operations: getStockQuote, getMarketIndices, getKlineChart, suggestStock, getHotPosts, searchPosts, searchUsers, getFinancialIncome, getFinancialIndicators, getStockScreener
