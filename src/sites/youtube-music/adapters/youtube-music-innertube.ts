...
function runs(obj: unknown): string {
...
function thumbUrl(item: Obj): string | null {
...
function browseContents(data: Obj): Array<Obj> {
...
function twoColBrowse(data: Obj): { primary: Array<Obj>; secondary: Array<Obj> } {
...
function parseShelfItems(shelf: Obj): Array<Obj> {
...
function parseCarouselItems(shelf: Obj): Array<Obj> {
  const contents = (shelf?.contents as Array<Obj>) ?? []
  return contents.map((c) => {
